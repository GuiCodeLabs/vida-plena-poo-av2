...
public class Main {
    ...
    public static void agendarPorEspecialidade() {
        ...
        consultas[totalConsultas] = new Consulta(cpf, profissionalEncontrado.nome, data, horario);
        totalConsultas++;
        System.out.println("Consulta agendada com " + profissionalEncontrado.nome + "!");
    }
